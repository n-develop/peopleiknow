...
namespace PeopleIKnow.UnitTests.ControllerTests.GiftControllerTests
{
    public class EditTests : BaseGiftControllerTests
    {
        ...
        {
            // Arrange
            _repository.GetByIdAsync(2).Returns(new Gift {Id = 2});
        ...
        public async Task Post_ReceivesValidMode_ReturnsRedirect()
        {
            // Arrange
            // Act
            var actionResult = await _sut.Edit(new Gift());
        ...
        public async Task Post_ReceivesValidModel_ReturnsRedirectToDetails()
        {
            // Arrange
            // Act
            var actionResult = await _sut.Edit(new Gift()) as RedirectToActionResult;
