...
{
    public class EditTests : BaseReminderControllerTests
    {
        [Fact]
        ...
        {
            // Arrange
            _repository.GetByIdAsync(2).Returns(new Reminder {Id = 2});
        ...
        public async Task Get_ReceivesValidId_ReturnsModelWithId()
        {
            ...
            model.Should().BeOfType<Reminder>();
            (model as Reminder).Id.Should().Be(2);
        }
        ...
        public async Task Post_ReceivesValidMode_ReturnsRedirect()
        {
            // Arrange
            // Act
            var actionResult = await _sut.Edit(new Reminder());
        ...
        public async Task Post_ReceivesValidModel_ReturnsRedirectToDetails()
        {
            // Arrange
            // Act
            var actionResult = await _sut.Edit(new Reminder()) as RedirectToActionResult;
