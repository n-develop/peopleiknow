...
{
    public class DeleteTests : BaseReminderControllerTests
    {
        [Fact]
        ...
        [Fact]
        public async Task CannotFindReminder_ReturnsNotFound()
        {
            // Arrange
        ...
        {
            // Arrange
            _repository.GetByIdAsync(1).Returns(new Reminder {ContactId = 2});
