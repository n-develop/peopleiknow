...
namespace PeopleIKnow.UnitTests.ControllerTests.CommonActivityControllerTests
{
    public class EditTests : TestBase
    {
        ...
        {
            // Arrange
            _repository.GetByIdAsync(2).Returns(new CommonActivity { Id = 2 });
        ...
        public async Task Get_ReceivesValidId_ReturnsModelWithId()
        {
            ...
            (model as CommonActivity).Id.Should().Be(2);
        }
        ...
        public async Task Post_ReceivesValidMode_ReturnsRedirect()
        {
            // Arrange
            // Act
            var actionResult = await _sut.Edit(new CommonActivity());
        ...
        public async Task Post_ReceivesValidModel_ReturnsRedirectToDetails()
        {
            // Arrange
            // Act
            var actionResult = await _sut.Edit(new CommonActivity()) as RedirectToActionResult;
